    ...
    MemoryBankController3.loadROM = function(romData){
        ...
        controller.readByte = function(offset) {
            switch (offset & 0xF000){
                ...
                case 0x6000:
                case 0x7000:
                    return this.ROMData[offset - 0x4000 + this.currentSecondaryBank * 0x4000] & 0xFF;
                case 0xA000:
                case 0xB000://RAM
                    if (this.RAMEnabled){
        ...
        controller.getSaveState = function(){
            return {
                ...
                RTC: CopyUtils.makeUntypedArrayCopy(this.RTC),
                lastRTCUpdate: this.lastRTCUpdate
            };
        }

        controller.setSaveState = function(saveState){
            if (saveState.type != GameUtils.MBC_3){
                console.error("Attempted to load wrong bank type");
                return;
            }
            CopyUtils.copy(saveState.ramData,this.RAMData);
            CopyUtils.copy(saveState.RTC,this.RTC);
            ...
            this.lastRTCUpdate = saveState.lastRTCUpdate;
            return this;
        }
